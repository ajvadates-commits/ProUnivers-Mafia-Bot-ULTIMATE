...
function adminsPanel(ownerId){return{inline_keyboard:[[{text:'➕ Admin qo‘shish',callback_data:'admin:add'}],...admins.all(ownerId).map(a=>[{text:`${a.enabled?'🟢':'🔴'} ${a.user_id}`,callback_data:`admin:view:${a.user_id}`}]),[{text:'⬅️ Owner panel',callback_data:'owner:panel'}]]};}
